...
define dso_local i32 @fib(i32 %0, i32 %1) #0 {
...
42:                                               ; preds = %20
  ...
  %53 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), double %52)
  store i32 0, i32* %1, align 4
